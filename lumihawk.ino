/**********************************************************************************
 *  TITLE: ESP RainMaker + IR + Switch control 1 Fan & 4 Relays using ESP32 & DHT11 (Feedback + no WiFi control + EEPROM)
 *  Click on the following links to learn more. 
 *  YouTube Video: https://youtu.be/2J5tXazJXaM
...
#define IR_Button_1  0xC00001
#define IR_Button_2   0xC00002
#define IR_Button_3  0xC00003
#define IR_Button_4  0xC00004
#define IR_Button_5   0xC00005
#define IR_Fan_Up     0xC00058
#define IR_Fan_Down   0xC00059
#define IR_All_On     0xC0000C
#define IR_All_Off    0xC00080
...
const char *service_name = "LUMIHAWK";
const char *pop = "Password1234";

// define the Chip Id
uint32_t espChipId = 2;
...
static uint8_t RelayPin4 = 25;  //D19
...
static uint8_t FanRelay2 =  21;  //D5
static uint8_t FanRelay3 = 19;  //D25
...
static Switch lightbulb(deviceName_2, &RelayPin2);
  ...
  if (irrecv.decode(&results)) {
      switch(results.value){
          ...
          case IR_Button_2:  
            ...
            pref.putBool("Relay2", toggleState_2);
            lightbulb.updateAndReportParam(ESP_RMAKER_DEF_POWER_NAME, toggleState_2);
            delay(100);            
            break;
          case IR_Button_3:  
...
void all_SwitchOff(){
  ...
  toggleState_2 = 0; digitalWrite(RelayPin2, HIGH); pref.putBool("Relay2", toggleState_2); lightbulb.updateAndReportParam(ESP_RMAKER_DEF_POWER_NAME, toggleState_2); delay(100);
...
void all_SwitchOn(){
  ...
  toggleState_2 = 1; digitalWrite(RelayPin2, LOW); pref.putBool("Relay2", toggleState_2); lightbulb.updateAndReportParam(ESP_RMAKER_DEF_POWER_NAME, toggleState_2); delay(100);
...
void setup()
{
  ...
  lightbulb.addCb(write_callback);
